...
2. **Provider-authorized browser route**
   ...
   - requires explicit provider-permission evidence recorded in governance;
...
- provider-authorized browser route with explicit permission evidence and real non-empty production results plus exact-SHA CI/live proof; or
