...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("conclusion_date_basis", sa.String(length=40), nullable=False),
...
def _contract_indexes() -> None:
    for name, columns in (
        ...
        ("ix_procurement_contracts_conclusion_date", ["conclusion_date"]),
...
def _drop_contract_indexes() -> None:
    for name in (
        ...
        "ix_procurement_contracts_conclusion_date",
